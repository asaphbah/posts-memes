<?php 
    require_once 'C:\xampp\htdocs\posts-memes/app/controller/ControllerConta.php';
    if (!isset($_SESSION)) {
        session_start();
    }
...
?>
            ...
            <div class="container-fluid" >
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  ...
                  <a class="nav-link active" aria-current="page" href="?pagina=conta">conta</a>
          ...
          <div class="user-bio">
            <div>
                <figure class="user-img">
                    <img src="img/user/<?=  $foto_usuario ?>" alt="">
                </figure>
                <p class="user-img-codinome"><?= $codinome_usuario?></p>
                <p class="user-img-seguidores">Seguidores:<span><?= $numero_seguidores?></span></p>
            </div>
            
            <div class="user-bio-text">
                <p class="user-bio-text-nome"><?= $nome_usuario?></p>
                <p class="user-bio-text-email"><?= $email_usuario ?></p>
                <p class="user-bio-text-descricao"><?= $descricao_usuario?></p>
                <a href="#alterar aqui" class="btn btn-padrao">Seguir</a>
            </div>
          </div>
          <div class="cont-list-post">
            <ul class="list-post">
              <?php foreach($postagens_usuario as $postagem){?>
                <?php $user = $contaController->getConta($postagem['id_usuario'])?>
                <li class="cont-post">
                    <div class="user-post">
 ...
 <!-- ===================================================VALIDA CURTIDA-->
                            <?php if($contaController->verCurtida($postagem['id'],$usuario['id']) == 0){ ?>
